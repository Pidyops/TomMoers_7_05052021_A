...
app.use(cookieParser()); //initialise, the we can se cookies
...
// Define Routes
// app.use('/forum', require('./routes/pages'));
...
// const publicDirectory = path.join(__dirname, './public' ) //hbs
// app.use(express.static(publicDirectory)); //hbs

// parse URL-encoded bodies (as sent by HTML forms)
// app.use(express.urlencoded({ extended: false}))  //hbs
